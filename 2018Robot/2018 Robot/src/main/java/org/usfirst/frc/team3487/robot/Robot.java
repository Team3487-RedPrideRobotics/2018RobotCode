...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		if(rightStick.getRawButton(11) == true && rightStick.getRawButton(12) == false) {
			climbingArm.set(-1);
		} else if(rightStick.getRawButton(11) == false && rightStick.getRawButton(12) == true) {
			climbingArm.set(1);
		} else if (rightStick.getRawButton(11) == false && rightStick.getRawButton(12) == false) {
			climbingArm.set(0);
		}

		if(rightStick.getRawButton(9) == true) {
			winch.set(-1);
		} else if (rightStick.getRawButton(9) == false) {
			winch.set(0);
		}
	}
